...
public class ConexionBDD {
	// Creamos una constante private
	private final static String DRIVER = "org.postgresql.Driver"; 
	private final static String URL = "jdbc:postgresql://localhost:5432/Datos"; 
	private final static String USUARIO = "postgres";
	private final static String CLAVE = "postgres";
	private static final Logger LOGGER = LogManager.getLogger(ConexionBDD.class);


	// Creamos la conexion y el objeto Conection
	public static Connection conectar() throws Exception {
		...
		try {
			...
			LOGGER.error("Error en la infraestrcutura", e);
			throw new Exception("Error en la infraestrcutura");
